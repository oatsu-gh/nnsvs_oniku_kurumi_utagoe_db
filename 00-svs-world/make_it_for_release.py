...
SINGER = 'oniku_kurumi'
PATH_QUESTION = 'conf/jp_qst001_nnsvs_simple_4_LLRR.hed'
NAME_EXPERIMENT = 'jp_qst001_nnsvs_simple_4_LLRR'
...
def copy_model(singer, name_exp):
    """
    name_exp: 試験のID
    """
...
def main():
    ...
    copy_scaler(SINGER)
    copy_model(SINGER, NAME_EXPERIMENT)
